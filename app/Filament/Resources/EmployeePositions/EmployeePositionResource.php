...
use App\Filament\Resources\EmployeePositions\Pages\ViewEmployeePosition;
use App\Filament\Resources\EmployeePositions\Schemas\EmployeePositionForm;
use App\Filament\Resources\EmployeePositions\Schemas\EmployeePositionInfolist;
...
class EmployeePositionResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'Employee Position';
    ...
    {
        return EmployeePositionInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewEmployeePosition::route('/{record}'),
