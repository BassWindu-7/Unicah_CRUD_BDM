...
use App\Filament\Resources\SaleDetails\Pages\ViewSaleDetail;
use App\Filament\Resources\SaleDetails\Schemas\SaleDetailForm;
use App\Filament\Resources\SaleDetails\Schemas\SaleDetailInfolist;
...
class SaleDetailResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'Sale Detail';
    ...
    {
        return SaleDetailInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewSaleDetail::route('/{record}'),
